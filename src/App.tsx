...
import type { CalcParams, CalcResult, CronoMode, FormValues, SavedSim } from "@/lib/types";
...
export default function App() {
  ...
  const [saved, setSaved] = useState<SavedSim[]>(() => loadSaved<SavedSim>("mortgage"));
  ...
  const guardarLocal = (): void => {
    if (persistSaved("mortgage", saved)) setGuardado(true);
  };
